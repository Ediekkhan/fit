...
const Shop = () => {
  return (
    <div className="container  bg-gray-100 mx-auto px-4 py-8">
      <h2 className="text-2xl  md:font-bold sm:font-semibold mb-4 text-center">
        Shop Our Products
      </h2>
        ...
        {products.map((product) => (
          ...
          >
            <img
              ...
              alt={product.name}
              className="w-full h-36  md:h-48 sm:h-48 lg:h-48 object-cover"
            />
            <div className="p-4">
              <div>
                <h3 className="text-sm sm:text-xl md:text-xl font-medium mb-2  ">
                  {product.name}
                </h3>
